    ...
    stages {
        ...
        stage('Deployment') {
            steps {
                ...
                catchError {
                    sh 'scp -o StrictHostKeyChecking=no -i C:/Python_AWS_MI_LCT/jenkins_demo.pem target/hello-world-java-1.0-SNAPSHOT.jar ubuntu@ip-172-31-9-24:/home/ubuntu/projectartifacts/'
